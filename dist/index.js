...
async function getPublicationsID() {
...
exports.getPublicationsID = getPublicationsID;
...
const gray_matter_1 = __importDefault(__nccwpck_require__(382));
const getPublicationsID_1 = __nccwpck_require__(73);
const publishPost_1 = __nccwpck_require__(929);
...
async function run() {
    ...
    files.forEach((file) => {
        if (file.endsWith(".md")) {
            const filePath = path_1.default.join(blogFolderPath, file);
            ...
            const updatedFileContent = gray_matter_1.default.stringify(content, newData);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.publishPostHandler = void 0;
...
async function publishPostHandler(input) {
    const response = await publishPost(input);
    if (response) {
        const post = response.data.publishPost.post.url;
...
exports.publishPostHandler = publishPostHandler;
...
const sections = __nccwpck_require__(762);
const defaults = __nccwpck_require__(256);
const stringify = __nccwpck_require__(905);
const excerpt = __nccwpck_require__(919);
const engines = __nccwpck_require__(190);
const toFile = __nccwpck_require__(652);
const parse = __nccwpck_require__(368);
const utils = __nccwpck_require__(405);
...
const getEngine = __nccwpck_require__(669);
const defaults = __nccwpck_require__(256);
...
const typeOf = __nccwpck_require__(961);
const getEngine = __nccwpck_require__(669);
const defaults = __nccwpck_require__(256);
...
const stripBom = __nccwpck_require__(550);
const typeOf = __nccwpck_require__(961);
...
var loader = __nccwpck_require__(187);
...
var extend = __nccwpck_require__(512);
